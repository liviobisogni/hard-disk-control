...
legend('Nominal system','Random samples','Location','SouthEast')    %legend('Nominal system','Random samples',2)
%
...
legend('Nominal system','Random samples','Location','NorthWest')    %legend('Nominal system','Random samples',4)
%
